...
public class profiel_aanmaken_opleiding extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //toevoegen.setBackgroundColor(Color.DKGRAY);
        ...
        toevoegen.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (!lijst.isEmpty()) {
                    ...
                    //toevoegen.setLinkTextColor(Color.BLUE);
                    //toevoegen.setText("ddddd");
                    //toevoegen.setBackgroundColor(Color.RED);
                    // toevoegen.setVisibility(View.INVISIBLE);
                    addd();
                }
            }
        });
        ...
        volgende.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*
                RelLayout.removeViewAt(0);
                RelLayout.removeViewAt(1);
                RelLayout.removeViewAt(2);
                RelLayout.removeViewAt(3);
                lijst.remove(0);
                lijst.remove(1);
                lijst_label.remove(0);
                lijst_label.remove(1);

                //RelLayout.getChildAt(3).setLayoutParams();
                int i = 2;
                RelLayout.getChildAt(i).setBackgroundColor(Color.RED);


                RelLayout.removeView(lijst.get(i));
                RelLayout.removeView(lijst.get(i+1));
                RelLayout.removeView(lijst_label.get(i));
                RelLayout.removeView(lijst_label.get(i + 1));

                lijst.remove(i + 1);
                lijst.remove(i);
                lijst_label.remove(i + 1);
                lijst_label.remove(i);

                RelLayout.getChildAt(i).setBackgroundColor(Color.RED);

                Toast.makeText(getApplicationContext(), " " + lijst.size(), Toast.LENGTH_SHORT).show();
                if ((lijst.size()) == i){
                    RelativeLayout.LayoutParams toevoegen_par = new RelativeLayout.LayoutParams(
                            RelativeLayout.LayoutParams.WRAP_CONTENT,
                            RelativeLayout.LayoutParams.WRAP_CONTENT
                    ...
                    if (i != 0) {
                        toevoegen_par.addRule(RelativeLayout.BELOW, RelLayout.getChildAt(i+1).getId());
                        toevoegen_par.addRule(RelativeLayout.CENTER_HORIZONTAL);
                    ...
                    Toast.makeText(getApplicationContext(), "!-!-!", Toast.LENGTH_SHORT).show();
                    if (i != 0) {
                        lab_par.addRule(RelativeLayout.BELOW, RelLayout.getChildAt(i+1).getId());
                    ...
                    RelLayout.getChildAt(i+2).setLayoutParams(lab_par);
                    RelLayout.getChildAt(i).setBackgroundColor(Color.RED);
                }
                */
            }
    ...
    public void addd() {
        String[] diplomas = {"", "Bacheler", "Master"};
        ...
        //img.getLayoutParams().height = px1;
        //img.getLayoutParams().width = px1;
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if ((lijst.size()) == ii) {
                            ...
                            //Toast.makeText(getApplicationContext(), "!-!-!", Toast.LENGTH_SHORT).show();
                            if (ii != 0) {//**
                                //toevoegen_par.addRule(RelativeLayout.BELOW, RelLayout.getChildAt(ii+2).getId());
                                toevoegen_par.addRule(RelativeLayout.BELOW, lijst.get(ii - 1).getId());
                                toevoegen_par.addRule(RelativeLayout.CENTER_HORIZONTAL);
                                toevoegen_par.setMargins(0, 0, 0, 25);
                                //Toast.makeText(getApplicationContext(), "LAATSTE!!!!!", Toast.LENGTH_LONG).show();
                            } else {//**
                                toevoegen_par.addRule(RelativeLayout.ALIGN_TOP);
                                toevoegen_par.addRule(RelativeLayout.CENTER_HORIZONTAL);
                                toevoegen_par.setMargins(0, 0, 0, 25);
                                //Toast.makeText(getApplicationContext(), "444_LAATSTE!!!!!", Toast.LENGTH_LONG).show();
                            }
                            RelLayout.removeView(toevoegen);
                            RelLayout.addView(toevoegen, toevoegen_par);
                        } else {
                            ...
                            if (ii != 0) {
                                ...
                                //lab_par.addRule(RelativeLayout.BELOW, RelLayout.getChildAt(ii+2).getId());
                                ...
                                int ber = (int) (ii * 2.5);
                                System.out.println("IF => => " + ii + " => " + (ii + 3) + " => " + ber);
                                ...
                                lab_par.addRule(RelativeLayout.CENTER_HORIZONTAL);
                                lab_par.setMargins(0, 0, 0, 25);
                                //Toast.makeText(getApplicationContext(), "000_EERSTE!!!!!", Toast.LENGTH_LONG).show();
